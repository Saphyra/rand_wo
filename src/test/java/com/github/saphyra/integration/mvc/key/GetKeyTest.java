...
public class GetKeyTest {
    ...
    public void notFound() throws Exception {
        //WHEN
        MockHttpServletResponse result = mockMvcWrapper.getRequest(KeyController.GET_KEY_MAPPING, KEY_ID);
        //THEN
    ...
    public void found() throws Exception {
        ...
        Key resultKey = objectMapperDelegator.readValue(result.getContentAsString(), Key.class);
